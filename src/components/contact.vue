      ...
      <div ref="contact" class="contact-content grid-x align-center-middle">
        ...
        <div class="cell small-10">
          <ul class="contact-content__social grid-x align-center">
            ...
            <li class="cell small-2">
              <a href="https://www.instagram.com/stephclaudon" title="Voir le profil de Stéphane Claudon sur Instagram">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
            ...
            <li class="cell small-2">
              <a href="https://vimeo.com/stephaneclaudon" title="Voir le profil de Stéphane Claudon sur Vimeo">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
